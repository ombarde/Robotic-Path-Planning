...
2. run python3 <filename.py> and choose the filename accordingly
    - **Holonomic robot with fixed obstacles** - run RRT_holonomic.py 
    - **Holonomic robot with hand drawn obstacles** - RRT_holonomic_drawn.py
    - **Non Holonomic robot with fixed obstacles** - run RRT_nonholonomic.py 
...
* We also find the wheel trajectories for all three wheels of the robot by following the RRT path.
   ...
   <img width="453" alt="holo_wheels" src="https://github.com/ombarde/Robotic-Path-Planning/assets/89467176/1d03fb59-8d4b-416a-8077-f59cd1567293"> 
...
* We also find the wheel trajectories for the two wheels of the robot by following the RRT path.
   ...
   <img width="453" alt="non_holo_wheels" src="https://github.com/ombarde/Robotic-Path-Planning/assets/89467176/a211a518-15b4-41aa-95ff-39b8376c67ce"> 

## RRT with Pygame Hand drawn obstacles
   <img width="453" alt="holo_draw" src="https://github.com/ombarde/Robotic-Path-Planning/assets/89467176/024ce9eb-881a-471c-a87a-30b7a7a0d76a"> 
